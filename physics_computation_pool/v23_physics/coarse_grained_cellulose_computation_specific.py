...
estimated_interaction_coefficients = (60.00,45.01,97.07,25.00,19.44,28.38,10.90,12.96,12.06,0.16,0.21,0.18,1.4,6.4,1.4,6.0,0.8,5.1,0.8,4.4,0.8,3.9,0.8,5.1,0.8,3.8,0.8,5.1)
...
\n\
pair_coeff 1 2 hbond/dreiding/lj/angleoffset 3 i {12} {13} 4 {14} {15} 135.0 164.0 # CL1-CL2\n\
pair_coeff 1 3 hbond/dreiding/lj/angleoffset 2 i {16} {17} 4 {18} {19} 135.0 164.0 # CL1-CL3\n\
