...
class CoarseGrainedCellulosePostProcessing():
    ...
    def post_processing_transverse_stretch(self,inputs_directory,results_directory,reference_relaxation_average_direction_angle,reference_fracture_average_direction_angle,reference_fracture_rotation_angle,reference_max_stress,reference_max_strain_energy,reference_equivalent_strain):
        ...
        try:
            ...
            if average_rmsd_data > average_rmsd_threshold:
                average_rmsd_match_degree = compute_square_root_match_degree(average_rmsd_data,average_rmsd_threshold)
                system_stable_enough_switch = system_stable_enough_switch*average_rmsd_match_degree
            if average_box_volume_change > average_box_volume_change_threshold:
                average_box_volume_match_degree = compute_square_root_match_degree(average_box_volume_change,average_box_volume_change_threshold)
                system_stable_enough_switch = system_stable_enough_switch*average_box_volume_match_degree
            if relaxation_average_direction_angle_difference > relaxation_average_direction_angle_difference_threshold:
                relaxation_average_direction_angle_match_degree = compute_square_root_match_degree(relaxation_average_direction_angle_difference,relaxation_average_direction_angle_difference_threshold)
                system_stable_enough_switch = system_stable_enough_switch*relaxation_average_direction_angle_match_degree
            ...
            if fracture_average_direction_angle_difference > fracture_average_direction_angle_difference_threshold:
                fracture_average_direction_angle_match_degree = compute_square_root_match_degree(fracture_average_direction_angle_difference,fracture_average_direction_angle_difference_threshold)
            ...
            if fracture_rotation_angle_difference > fracture_rotation_angle_difference_threshold:
                fracture_rotation_angle_match_degree = compute_square_root_match_degree(fracture_rotation_angle_difference,fracture_rotation_angle_difference_threshold)
