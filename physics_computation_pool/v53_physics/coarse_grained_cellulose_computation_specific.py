...
estimated_interaction_coefficients = (62.00,51.00,136.39,30.00,14.96,25.89,17.65,20.77,10.82,0.25,0.22,0.23,1.4,6.1,1.4,5.9,0.8,5.1,0.8,3.9,0.8,4.0,0.8,5.1,0.8,3.7,0.8,5.1)
...
\n\
pair_coeff 1 2 hbond/dreiding/lj/angleoffset 3 i {12} {13} 4 {14} {15} 135.0 167.1 # CL1-CL2\n\
pair_coeff 1 3 hbond/dreiding/lj/angleoffset 2 i {16} {17} 4 {18} {19} 135.0 167.1 # CL1-CL3\n\
