...
for training_data_file_name in training_data_file_name_list:
    if training_data_file_name.__contains__('_cellulose_data_pool-'):
        ...
        coeffcients_pool_file_name_list.append(training_data_file_name)
...
if total_cellulose_data_pool_file_number > 0 and total_cellulose_data_pool_file_number == total_coeffcients_pool_file_number:
    ...
    for i in range(0,total_cellulose_data_pool_file_number):
        ...
        try:
            ...
            temp_coeffcients_pool = numpy.loadtxt(training_data_directory+temp_coeffcients_pool_file_name)
        except:
            temp_cellulose_data_pool = numpy.loadtxt(training_data_directory+temp_cellulose_data_pool_file_name,delimiter=',')
            temp_coeffcients_pool = numpy.loadtxt(training_data_directory+temp_coeffcients_pool_file_name,delimiter=',')
