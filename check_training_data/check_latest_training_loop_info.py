...
if total_cellulose_data_pool_file_number > 0 and total_cellulose_data_pool_file_number == total_coefficients_pool_file_number:
    ...
    try:
        latest_cellulose_data_pool = numpy.loadtxt(training_data_directory+latest_cellulose_data_pool_file_name)
        latest_coefficients_pool = numpy.loadtxt(training_data_directory+latest_coefficients_pool_file_name)
    except:
        latest_cellulose_data_pool = numpy.loadtxt(training_data_directory+latest_cellulose_data_pool_file_name,delimiter=',')
        latest_coefficients_pool = numpy.loadtxt(training_data_directory+latest_coefficients_pool_file_name,delimiter=',')
