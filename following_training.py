...
one_training_loop_timestep = int(sys.argv[2])

total_training_loop_number = int(sys.argv[3])
...
trained_agent_directory = coarse_grained_cellulose_computation_home_directory+'coarse_grained_cellulose_coefficients_data/training_data/{0}_training_data/{0}_trained_agents/'.format(target_version)
