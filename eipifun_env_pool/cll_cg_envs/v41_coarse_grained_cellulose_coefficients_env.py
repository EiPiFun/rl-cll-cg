...
class CoarseGrainedCelluloseCoefficientsEnv(gym.Env):
    ...
    def step(self, action):
        ...
        temp_fitted_elastic_modulus,temp_elastic_modulus_match_degree,temp_average_bond_length,temp_average_persistence_length,temp_persistence_length_match_degree,temp_average_end_to_end_distance,temp_end_to_end_distance_match_degree,temp_reward_value = temp_coarse_grained_cellulose_coefficients_env_class.processing_bonded(temp_interaction_coefficients)
