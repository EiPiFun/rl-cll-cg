...
class CoarseGrainedCelluloseCoefficientsEnv(gym.Env):
    ...
    def step(self, action):
        ...
        temp_interaction_coefficients = (temp_bc_1,temp_bc_2,temp_bc_2_3,temp_bc_2_4,temp_bc_3,temp_ac_1,temp_ac_2,temp_ac_2_3,temp_ac_2_4,temp_ac_3,temp_ac_4,temp_ac_4_3,temp_ac_4_4,temp_ac_5,temp_ac_6,temp_ac_6_3,temp_ac_6_4,temp_ic_1,temp_ic_2,temp_ic_3)

        temp_coarse_grained_cellulose_coefficients_env_common_class = CoarseGrainedCelluloseCoefficientsEnvCommon(coarse_grained_cellulose_computation_home_directory,coarse_grained_cellulose_computation_code_directory,physics_version)
        temp_fitted_elastic_modulus,temp_elastic_modulus_match_degree,temp_average_bond_length,temp_average_persistence_length,temp_persistence_length_match_degree,temp_average_end_to_end_distance,temp_end_to_end_distance_match_degree,temp_reward_value = temp_coarse_grained_cellulose_coefficients_env_common_class.processing_bonded(temp_interaction_coefficients)
